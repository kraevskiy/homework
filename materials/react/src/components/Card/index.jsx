...
export const Card = ({ data, loading, ...props }) => {
	...
	return (
		<div
			...
			<div className="p-5 flex flex-col items-start flex-auto">
				...
				<a href={data.id}
					 className="inline-flex mt-auto items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
					Read more
